                ...
                },   
                {
                    ...
                    Cell: ({row}) => { 
                       ...
                       <button onClick={()=>{ 
                        ...
                        }} className="btn btn-primary btn-block btn-sm col-12 mb-1"> <i className="bi bi-pen"></i> Details</button>  
                       </>            
                    }
                }
            ],
        ...
        return <DashboardLayout title="Holidays" user={this.props.auth.user} ><div className="noselect">
            <div className="app-content-header"> 
                <div className="container-fluid"> 
                    <div className="row">
                    <div className="col-sm-6"><h3 className="mb-0"><i className="nav-icon bi bi-calendar3"></i> Event</h3></div>
                        ...
                        <div className="col-lg-12">
                            <div className="card mb-4">
                                <div className="card-header">
                                    <h3 className="card-title"> <i className="bi bi-calendar3"></i> Event List</h3> 
        ...
        <div className="modal fade" tabIndex="-1" role="dialog" id="newHoliday" aria-hidden="true" data-bs-backdrop="static">
            <div className="modal-dialog" role="document">
                ...
                <div className="modal-header">
                    <h5 className="modal-title fs-5">Create Event</h5>
                ...
                <div className="modal-body">
                    ...
                    <div className="card-body"> 
                        ...
                        <div className="col-md-12">
                                <label htmlFor="grade" className="form-label">Event Type</label>                                            
