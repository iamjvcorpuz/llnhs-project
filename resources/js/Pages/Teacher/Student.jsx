                                    ...
                                    <div className="browser-hidden">
                                        <EachMethod of={this.state.data} render={(element,index) => {
                                            return <div className="row mb-0">
                                                <div className="col-sm-3 mr-0 pr-0">
                                                    <img className="" height={100} width={100}  onError={(e)=>{ 
                                                            e.target.src=(element.sex=="Male")?'/adminlte/dist/assets/img/avatar.png':'/adminlte/dist/assets/img/avatar-f.jpeg'; 
                                                    }} alt="Picture Error" src={(element.photo!=null&&element.photo!="")?element.photo:(element.sex=="Male")?'/adminlte/dist/assets/img/avatar.png':'/adminlte/dist/assets/img/avatar-f.jpeg'} />
                                                </div>
                                                <div className="col-sm-6 ml-0 pl-0">
                                                    <div className="row">
                                                        <label>LRN: {element.lrn  }</label>
                                                    </div>
                                                    <div className="row">
                                                        <label>Name: {element.fullname  }</label>
                                                    </div>
                                                </div>
                                                <div className="col-sm-3">
                                                    <button className="btn btn-primary btn-block btn-sm " onClick={()=>{ }}> <i className="bi bi-person"></i> View Profile</button>
                                                </div>
                                                <hr className="mt-3" />
                                            </div>
                                        }} />
