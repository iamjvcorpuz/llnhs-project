                ...
                },
                {
                    ...
                    Cell: ({row}) => { 
                       return <>                       
                        ...
                        <a target="_blank" href={`/student/id/print/${row.original.id}`} className="btn btn-info btn-block btn-sm col-12 mb-1" onClick={()=>{ }}> <i className="bi bi-printer"></i> Print ID</a>    
                       </>            
                    }
                }
            ]
