...
export default class AdvisoryList extends Component {
    constructor(props) {
		super(props);
        this.state = {
        ...
        return <DashboardLayout title="Subject" user={this.props.auth.user}>
            <div className="app-content-header"> 
                <div className="container-fluid"> 
                    <div className="row">
                    <div className="col-sm-6"><h3 className="mb-0"><i className="nav-icon bi bi-book-half"></i>Advisory</h3></div>
                                            ...
                                            return {
                                                onDoubleClick: (e) => { 
                                                    ...
                                                    if(typeof(temp) != "undefined") {
                                                        window.location.replace(`/admin/class/advisory/schedules/details/${temp.qr_code}/${original.qrcode}`)
                                                    }
                                                    // 
                                                }
                                            };
