...
export default class AttendanceMobilePage extends Component {
    constructor(props) {
		super(props);
        this.state = {
        ...
        setInterval(() => {
            ...
            if(loop_test==0) {
                this.setState({
                    time_logs_status: "bg-success",time_logs_status_message:"Time In"
                });
                loop_test++;
            } else if(loop_test==1) {
                this.setState({
            ...
            <div className="">
                ...
                <div className="log-center-data">
                    ...
                    <div className="header_time">
                        ...
                        <div className="logger-name"><strong>{this.state.fullname}</strong></div> 
                        <div className="logger-name-small">{this.state.logger_sectoin}</div>
                    ...
                    <div className="view_list_right_side">
                        <EachMethod of={this.state.attendance_data} render={(element,index) => {
                            return <div className="image_list"  key={index}>
                                ...
                                <p className="logo_round_mini_name badge bg-success" >{element.timelogs}</p>
                            </div>                    
                        }} />                        
                    </div>
                </div>
